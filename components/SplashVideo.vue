...
<transition name="splash-video">
    <div class="splash-video" v-if="open" v-cloak="v-cloak">
        <div class="backdrop"></div>
        <div class="modal-window">
            <div class="modal-window__video"><iframe width="853" height="480" :src="autoplayUrl" frameborder="0" allowfullscreen="allowfullscreen"></iframe></div>
            <button class="modal-window__button button" @click="close">✕</button>
        </div>
    </div>
</transition>
</template>
