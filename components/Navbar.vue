...
<div class="navbar" :class="isOpen &amp;&amp; 'open'">
    <div class="navbar__container">
        <nuxt-link class="navbar__logo" to="/"><img src="~/assets/vuelogo.svg" width="40" height="36" />VueConf US</nuxt-link><button class="navbar__burger" type="button" @click="toggle"><div class="bar"></div><div class="bar"></div><div class="bar"></div></button>
        <nav>
            <ul class="navbar-nav" @click="toggle">
                ...
                <li class="navbar-nav__item"><a class="button" href="https://tickets.connectevents.io/events/vueconf2019/">Register</a></li>
            </ul>
        </nav>
    </div>
</div>
