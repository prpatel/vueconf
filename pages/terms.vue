...
.container
  .container__inner
    :markdown-it
      ...
      2. Monterail shall respond to your complaint immediately, no later than within 14 days of receipt thereof, in the same form the complaint was filed.
...
export default {
  head: {
    title: 'VueConf US 2018 | Terms & Conditions'
  }
}
</script>
