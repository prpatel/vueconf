...
div
  .container
    ...
    .container__inner
      ...
      attraction(v-for="hotel of hotels" :attraction="hotel" :key="hotel.title")
      ...
      attraction(v-for="restaurant of restaurants" :attraction="restaurant" :key="restaurant.title")
      h2: strong Good to know
      p.
        A bit more key information to make your stay comfortable!

      hint(v-for="hint of hints" :hint="hint" :key="hint.title")
      ...
      attraction(v-for="sight of sights" :attraction="sight" :key="sight.title")
</template>
